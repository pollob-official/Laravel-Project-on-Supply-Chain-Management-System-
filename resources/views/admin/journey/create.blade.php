    ...
    <form action="{{ URL('journey/save') }}" method="POST" class="p-4 border rounded shadow-sm bg-light">
            ...
            <div class="col-md-4 mb-3">
                ...
                <select name="seller_id" class="form-select form-control" required>
                    ...
                    @foreach ($stakeholders as $stakeholder)
                        <option value="{{ $stakeholder->id }}">{{ $stakeholder->name }} ({{ ucfirst($stakeholder->role) }})
                        </option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2 mb-3">
                ...
                <input type="number" name="profit_margin" id="profit_margin" class="form-control bg-light" readonly
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="number" step="0.01" name="selling_price" id="selling_price"
                    class="form-control bg-white fw-bold" readonly>
            </div>
        </div>
